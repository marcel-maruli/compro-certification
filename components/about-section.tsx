...
const highlights = [
  {
    ...
    description: "Kami memetakan kebutuhan regulasi dan langkah kerja tanpa bahasa yang berputar-putar.",
  },
  {
    icon: Boxes,
    title: "Pendekatan berbasis produk",
    description: "Setiap kategori produk diperlakukan sesuai risiko, dokumen, dan tujuan distribusinya.",
  },
  {
    icon: Clock3,
    title: "Proses responsif",
    description: "Tim kami bergerak cepat dari review awal sampai pendampingan final.",
  },
  {
    icon: Leaf,
    title: "Solusi yang ramah UMKM",
    description: "Kami merancang alur yang realistis, terjangkau, dan tetap patuh standar.",
  },
];
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <Reveal className="space-y-6">
            ...
            <p className="max-w-xl text-lg leading-8 text-slate-600">
              CertiTrust mendampingi proses sertifikasi BPOM dan standardisasi produk dengan
              pendekatan yang rapi, hangat, dan berbasis detail. Kami membantu tim Anda
              menghindari revisi berulang, mempercepat validasi, dan menjaga kepercayaan pasar.
            </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={stat.label} className="rounded-3xl border border-teal-50 bg-white p-6 shadow-card">
                  <div className="text-3xl font-extrabold text-teal-600">{stat.value}</div>
