      ...
      <div className="mx-auto max-w-7xl rounded-[1.75rem] border border-white/70 bg-white/80 shadow-[0_20px_50px_-25px_rgba(15,23,42,0.18)] backdrop-blur-xl">
        <div className="flex items-center justify-between gap-3 px-4 py-3 sm:px-5">
          ...
          <div className="hidden md:block">
            <a href="#kontak" className="inline-flex items-center rounded-full bg-teal-500 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-teal-500/20 transition duration-300 hover:-translate-y-0.5 hover:bg-teal-600 hover:shadow-xl hover:shadow-teal-500/30">
              Konsultasi Gratis
            </a>
          </div>
